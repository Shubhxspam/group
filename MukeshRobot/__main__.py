    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/Seethistoknow"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url="https://github.com/Shubhxspam"
                        ),
                    ],
                    [
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_caption("""ɪғ ʏᴏᴜ ᴀʀᴇ ᴍᴏᴠɪᴇ ʟᴏᴠᴇʀ ᴀɴᴅ ᴛɪʀᴇᴅ ᴏғ ᴀʟʟ ᴘᴀɪᴅ sɪᴛᴇs , ᴛʜᴇɴ ᴜ ᴀʀᴇ ɪɴ ʀɪɢʜᴛ ᴘʟᴀᴄᴇ. 

ʜᴇʀᴇ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀɴʏ ᴍᴏᴠɪᴇ (ɴᴇᴡ/ᴏʟᴅ) ᴀᴛ ᴀɴʏ ᴛɪᴍᴇ.

/ᴍᴏᴠɪᴇ :- ғᴏʀ ᴀɴʏ ɴᴏᴠɪᴇ  ᴏʀ ᴛᴀᴘ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.""",parse_mode=ParseMode.MARKDOWN,
...
*ʜᴇʀᴇ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀɴʏ ᴍᴏᴠɪᴇ :* [ᴍᴏᴠɪᴇs]("https://t.me/MoviesWDs_bot)
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="ᴍᴏᴠɪᴇs", url="https://t.me/MoviesWDs_bot")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="mukesh_back"),
        InlineKeyboardButton(text="🛡️", callback_data="mukesh_"),
        ...
        first_name = update.effective_user.first_name
        query.message.edit_caption(
            PM_START_TEXT.format(escape_markdown(first_name), BOT_NAME,len(get_served_users()),len(get_served_chats())),
            reply_markup=InlineKeyboardMarkup(buttons),
            parse_mode=ParseMode.MARKDOWN,
            timeout=60,
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        update.effective_message.reply_text(
            DONATE_STRING, parʏᴏᴜse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True
        )
