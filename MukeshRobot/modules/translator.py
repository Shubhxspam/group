...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    if not reply_msg:
        message.reply_text(
            ...
            "ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ sᴇᴇ [ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ʟᴀɴɢᴜᴀɢᴇ ᴄᴏᴅᴇs](https://t.me/Seethistoknow/51).",
            parse_mode="markdown",
...
**ғᴏʀ ᴀɴʏ ᴍᴏᴠɪᴇ, ᴛᴀᴘ ᴏɴ ᴍᴏᴠɪᴇs ᴀɴᴅ ɢᴇᴛ ɪᴛ.**
""",
