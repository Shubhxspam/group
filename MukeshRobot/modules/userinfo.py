...
ID_HANDLER = DisableAbleCommandHandler("idh", get_id, run_async=True)
GIFID_HANDLER = DisableAbleCommandHandler("gifid", gifid, run_async=True)
INFO_HANDLER = DisableAbleCommandHandler(("infoh", "book"), info, run_async=True)
...
__mod_name__ = "Iɴꜰᴏ"
__command_list__ = ["setbio", "bio", "setme", "me", "infoh"]
__handlers__ = [
    ID_HANDLER,
    GIFID_HANDLER,
    INFO_HANDLER,
